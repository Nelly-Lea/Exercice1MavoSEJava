...
class PlaneTest {
    ...
    void findIntersections() {
        ...
        List<Point3D> result1 =p.findIntersections(new Ray(new Point3D(-1.5, 0, 0),
                new Vector(0, 1, 0.5)));
        assertEquals(null,result1,"Bad plane intersection");

        //test 1 point of intersection
        List<Point3D> result2 =p.findIntersections(new Ray(new Point3D(-1.5, 0, 0),
                new Vector(2.5, 0, 0.5)));
        assertEquals(1,result2.size(), "Bad plane intersection");
